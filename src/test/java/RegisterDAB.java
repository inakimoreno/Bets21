...
public class RegisterDAB {
	...
	public void test4() {
		...
		newUser = sut.register(null, "Urrutia", "Garcia", "antxon18", "12345678",
				"666666666","antxon@gmail.com", date, "admin");
		assertNull(newUser);
	...
	public void test5() {
		...
		newUser = sut.register("Antxon", null, "Garcia", "antxon18", "12345678",
				"666666666","antxon@gmail.com", date, "admin");
		assertNull(newUser);
	...
	public void test6() {
		...
		newUser = sut.register("Antxon", "Urrutia", null, "antxon18", "12345678",
				"666666666","antxon@gmail.com", date, "admin");
		assertNull(newUser);
	...
	public void test7() {
		...
		newUser = sut.register("Antxon", "Urrutia", "Garcia", null, "12345678",
				"666666666","antxon@gmail.com", date, "admin");
		assertNull(newUser);
	...
	public void test8() {
		...
		newUser = sut.register("Antxon", "Urrutia", "Garcia", "antxon18", null,
				"666666666","antxon@gmail.com", date, "admin");
		assertNull(newUser);
	...
	public void test9() {
		...
		newUser = sut.register("Antxon", "Urrutia", "Garcia", "antxon18", "12345678",
				null,"antxon@gmail.com", date, "admin");
		assertNull(newUser);
		} catch (Exception e) {
			e.printStackTrace();
			fail();
	...
	public void test11() {
		...
		newUser = sut.register("Antxon", "Urrutia", "Garcia", "antxon18", "12345678",
				"666666666","antxon@gmail.com", null, "admin");
		assertNull(newUser);
	...
	public void test12() {
		...
		newUser = sut.register("Antxon", "Urrutia", "Garcia", "antxon18", "12345678",
				"666666666","antxon@gmail.com", date, null);
		assertNull(newUser);
	...
	public void test13() {
		...
		newUser = sut.register("Antxon", "Urrutia", "Garcia", "antxon18", "12345678",
				"666666666","antxon@gmail.com", underageDate, "admin");
		testDA.open();
		assertNull(newUser);	
